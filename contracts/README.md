...
**setRegistrationFee()**
```
ioctl contract invoke function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi setRegistrationFee --with-arguments '{"fee":"1"}' --endpoint api.testnet.iotex.one:443
...
...
**registrationFee()**
```
ioctl contract test function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi registrationFee --endpoint api.testnet.iotex.one:443
return: 1
```

**setSubscriptionFee()**
```
ioctl contract invoke function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi setSubscriptionFee --with-arguments '{"fee":"1"}' --endpoint api.testnet.iotex.one:443
...
...
**subscriptionFee()**
```
ioctl contract test function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi subscriptionFee --endpoint api.testnet.iotex.one:443
return: 1
```
...
```
ioctl contract invoke function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi preRegisterDevice --with-arguments '{"_deviceIdHash":"0x87b94e1b4114ed2746e032605265993b811798401bee23d749a8f3c61f0ae16a"}' --endpoint api.testnet.iotex.one:443
...
...
**getDeviceInfoByID()**
```
ioctl contract test function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi getDeviceInfoByID --with-arguments '{"_deviceId":"0x0000000000000000000000000000000000333532363536313030373934363132"}' --endpoint api.testnet.iotex.one:443
...
```
ioctl contract invoke function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi subscribe 10 --with-arguments '{"_deviceId":"0x0000000000000000000000000000000000333532363536313030373934363132","_duration":"4","_storageEPoint":"trypebble.io/123456","_storageToken":"abcdef"}' -l 10000000 --endpoint api.testnet.iotex.one:443
...
...
**getDeviceOrderByID()**
```
ioctl contract test function io12wm2lz8z3jac2ey9fa6eemmejm24qsghugnmfr a.abi getDeviceOrderByID --with-arguments '{"_deviceId":"0x0000000000000000000000000000000000333532363536313030373934363132"}' --endpoint api.testnet.iotex.one:443
