...
### Invoke
We use `io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l` deployed on testnet (via this [action](https://testnet.iotexscan.io/action/ea8029f6c85ed453a6d81b26e08adb30ee00187805f43cd5b732d2c9393a757ciote)) as an example to invoke.

**setRegistrationFee()**
```
ioctl contract invoke function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi setRegistrationFee --with-arguments '{"fee":"1"}' --endpoint api.testnet.iotex.one:443
...
...
**registrationFee()**
```
ioctl contract test function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi registrationFee --endpoint api.testnet.iotex.one:443
return: 1
```

**setSubscriptionFee()**
```
ioctl contract invoke function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi setSubscriptionFee --with-arguments '{"fee":"1"}' --endpoint api.testnet.iotex.one:443
...
...
**subscriptionFee()**
```
ioctl contract test function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi subscriptionFee --endpoint api.testnet.iotex.one:443
return: 1
```
...
```
ioctl contract invoke function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi preRegisterDevice --with-arguments '{"_deviceIdHash":"0x87b94e1b4114ed2746e032605265993b811798401bee23d749a8f3c61f0ae16a"}' --endpoint api.testnet.iotex.one:443
...
...
**updateDevice()**
```
ioctl contract invoke function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi updateDevice --with-arguments '{"_deviceId":"0x0000000000000000000000000000000000333532363536313030373834343135","_freq":"30","_price":"1","_spec":"trypebble.io/123","_rsaPubkeyN":"","_rsaPubkeyE":"0x010001"}' -l 10000000 --endpoint api.testnet.iotex.one:443
...
...
**getDeviceInfoByID()**
```
ioctl contract test function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi getDeviceInfoByID --with-arguments '{"_deviceId":"0x0000000000000000000000000000000000333532363536313030373934363132"}' --endpoint api.testnet.iotex.one:443
...
**getDeviceOrderByID()**
```
ioctl contract test function io1cq02j7meeaxk6nr2cujgcfe2d3j5pkw4xus30l a.abi getDeviceOrderByID --with-arguments '{"_deviceId":"0x0000000000000000000000000000000000333532363536313030373934363132"}' --endpoint api.testnet.iotex.one:443
...
Contract `io1qvvzehk42l0g86xwnrszjhna53urpa7zwex80t` has been deployed on mainnet (via this [action](https://iotexscan.io/action/640ab6ae520be7cbfbfba3f3e56426c32b4030850d499497e9977d88f76b4830))
